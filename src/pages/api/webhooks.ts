            ...
            try {
                switch (type) {
                    ...
                    case 'checkout.session.completed':
                        const checkoutSession = event.data.object as Stripe.Checkout.Session | any;
                        await saveSubscription(
                ...
                console.log(err) // Faz o log
                return res.status(400).json({ error: 'Webhook handler failed'}) // Adiciona o status
              }
        }
